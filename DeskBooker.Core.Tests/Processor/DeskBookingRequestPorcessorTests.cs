...
{
    public class DeskBookingRequestPorcessorTests
    {
        ...
        public DeskBookingRequestPorcessorTests()
        {
            _request = new DeskBookingRequest
            {
                FirstName = "Thomas",
                LastName = "Hube",
                Email = "miguel.delgadop@gmail.com",
            ...
            _deskRepositoryMock.Setup(d => d.GetAvailableDesks(_request.Date))
